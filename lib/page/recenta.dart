...
class recentaPage extends StatefulWidget {
  @override
  _recentaPageState createState() => _recentaPageState();
}

class _recentaPageState extends State<recentaPage> {
  get onLikeButtonTapped => null;

  // const recentaPage({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
   ...
   Widget _home() {
    return Padding(
      padding:
          const EdgeInsets.only(top: 15.0, left: 20.0, right: 20.0, bottom: 5.0),
